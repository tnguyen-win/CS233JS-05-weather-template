...
export const DayForecastSummary = function(day, i, temperature_type) {
    return `
        <div class='weather-list-item d-inline-block user-select-none text-bg-secondary border border-light' style='--bs-border-opacity: 0.1875;' data-index='${i}'>
            ...
            <h3>${getTemperatureWithSuffix(day.minTemp, temperature_type)} | ${getTemperatureWithSuffix(day.maxTemp, temperature_type)}</h3>
        </div>
    `;
};
